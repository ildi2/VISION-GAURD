...
def test_merge_manager_api(results):
    ...
    try:
        ...
        # Test API methods exist and callable
...
def test_canonical_id_mapping(results):
    ...
    try:
        ...
        # Get all tracklets for canonical
...
def test_main_loop_integration(results):
    ...
    try:
        ...
        # merge_cfg could be dict or dataclass, handle both
...
def test_identity_schema_update(results):
    ...
    try:
        ...
        # Create decision with canonical_id
