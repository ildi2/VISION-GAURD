# schemas/face_sample.py
#
# Canonical description of a single face observation in GaitGuard.
#
# This is the 3D-ready / multiview-compatible schema used by:
#   - FaceRoute (runtime evidence → FaceSample via IdentityEngine)
#   - IdSignals.best_face / recent_faces
#   - IdentityEngine (classic) and IdentityEngineMultiView
#   - Enrollment pipeline (file-based or live)
#
# Design goals:
#   - Lightweight: only typing + numpy imports.
#   - Backwards-compatible: older code that only cares about bbox/embedding/quality
#     can still construct FaceSample using keyword arguments.
#   - Forward-ready: contains yaw / pitch / roll / pose_bin / det_score for
#     pseudo-3D and multiview logic.
