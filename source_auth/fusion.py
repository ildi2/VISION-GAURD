...
def fuse_source_auth(
    ...
    alpha = float(getattr(cfg, "ema_alpha", 0.35))
    ...
    real_min = float(getattr(cfg, "real_min_score", 0.75))
    likely_real_min = float(getattr(cfg, "likely_real_min_score", 0.55))
    spoof_max = float(getattr(cfg, "spoof_max_score", 0.15))
    likely_spoof_max = float(getattr(cfg, "likely_spoof_max_score", 0.35))
