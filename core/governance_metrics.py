...
class GovernanceMetrics:
    ...
    # =====================================================================
    # EVIDENCE GATING METRICS (Phase B)
    # =====================================================================
    faces_total: int = 0                           # Total faces processed
    faces_accepted: int = 0                        # ACCEPT decisions
    faces_held: int = 0                            # HOLD decisions (borderline)
    faces_rejected: int = 0                        # REJECT decisions
    ...
    # Examples:
    #   "pending_strict_threshold": 3
    #   "borderline_quality": 2
    
    # =====================================================================
    # BINDING STATE MACHINE METRICS (Phase C)
    # =====================================================================
    ...
    binding_confirmations: int = 0                 # Tracks confirmed this second
    binding_downgrades: int = 0                    # Confidence decreased (contradiction)
    binding_switches: int = 0                      # Tracks switched person
    binding_switch_failures: int = 0               # Switch attempted but rejected
    binding_contradiction_events: int = 0          # Contradiction counter incremented
    
    # =====================================================================
    # SCHEDULER METRICS (Phase D)
    # =====================================================================
    scheduler_budget_available: int = 0            # Faces available this frame
    scheduler_selected: int = 0                    # Selected for processing
    scheduler_skipped: int = 0                     # Deferred
    scheduler_starved: int = 0                     # Forced process (starvation)
    
    # =====================================================================
    # MERGE METRICS (Phase E)
    # =====================================================================
    merge_attempts: int = 0                        # Attempted merges
    merge_success: int = 0                         # Successful merges
    merge_collision_risk: int = 0                  # Rejected (collision risk)
    
    # =====================================================================
    # SYSTEM HEALTH METRICS
    # =====================================================================
    fps_estimate: float = 0.0                      # FPS over last second
    track_count: int = 0                           # Active tracklets
    unknown_rate: float = 0.0                      # % of tracks in UNKNOWN
    pending_rate: float = 0.0                      # % of tracks in PENDING
    confirmed_rate: float = 0.0                    # % confirmed
    ...
    def reset(self) -> None:
        ...
        # Keep system metrics (computed per frame)
...
class MetricsCollector:
    ...
    def maybe_emit(self) -> bool:
        ...
        if now - self.last_emit_time >= self.interval_sec:
            ...
            # Full JSON for structured logging
