# chimeric_identity/adapters/source_auth_adapter.py
# ============================================================================
# SOURCE AUTH ADAPTER - Spoof Detection Integration
# ============================================================================
#
# Purpose:
#   Convert SourceAuthEngine outputs into normalized SourceAuthEvidence.
#   Integrates spoof detection into chimeric fusion pipeline.
#
# Design Philosophy:
#   - Optional: Can be disabled if SourceAuth not available
#   - Defensive: Graceful degradation if spoof detection fails
#   - Conservative: Err toward UNCERTAIN if confidence low
#
# Input: SourceAuthScores from SourceAuthEngine
# Output: SourceAuthEvidence (normalized schema)
#
# Key Innovation:
#   Translates motion-based 3D detection + screen artifacts + background
#   consistency into clear REAL/SPOOF decision that blocks learning/identity.
...
class SourceAuthAdapter:
    ...
    def adapt_scores(
        ...
        # Try to extract realness score
        realness_score = None
        
        # Try multiple attribute names (defensive)
        ...
        # If extraction failed, return UNCERTAIN
        ...
        source_auth_ev = SourceAuthEvidence(
            ...
            state=state,
            timestamp=now,
            reason=None,  # Can be filled from source_auth_scores.reason
            extra={
    ...
    def should_block_learning(
        ...
        """
        if source_auth_ev is None:
            return False  # If no spoof detection, allow learning
        
        # Only learn when clearly real
...
# ============================================================================
# END OF SOURCE AUTH ADAPTER MODULE
# ============================================================================
