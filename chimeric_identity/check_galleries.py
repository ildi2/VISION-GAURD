# chimeric_identity/check_galleries.py
# ============================================================================
# GALLERY STATUS CHECKER - See what's enrolled in each gallery
# ============================================================================
...
def check_face_gallery():
    ...
    try:
        ...
        # List all persons (correct method is list_persons)
...
def find_matching_names(face_persons, gait_identities):
    ...
    # Extract names from face gallery
    face_names = {}
