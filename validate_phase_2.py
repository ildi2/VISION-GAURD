...
class Phase2Validator:
    ...
    def test_quality_boost_below_threshold(self):
        ...
        # Below threshold but close: still high boost
        ...
        # Much lower quality: lower boost
        ...
        # Verify smooth degradation: as quality decreases, boost decreases
    ...
    def test_adaptive_weights_face_only(self):
        ...
        # Create face evidence with no gait
    ...
    def test_adaptive_weights_gait_only(self):
        ...
        # Create gait evidence with no face
    ...
    def test_adaptive_weights_high_quality_face(self):
        ...
        # High quality face + low quality gait → face-dominant
    ...
    def test_adaptive_weights_low_face_high_gait(self):
        ...
        # Low face + high gait → gait weight increased
    ...
    def test_temporal_reliability_short_sequence(self):
        ...
        gait_ev = GaitEvidence(
            ...
            sequence_length=30, confirm_streak=2  # Short
        )
        ...
        # Short sequence should give low reliability (but not zero)
    ...
    def test_temporal_reliability_long_sequence(self):
        ...
        gait_ev = GaitEvidence(
            ...
            status=EvidenceStatus.CONFIRMED_STRONG, margin=0.12,
            sequence_length=150, confirm_streak=12  # Long
        )
        ...
        # Long sequence should give high reliability
    ...
    def test_confidence_synthesis_high_quality_face(self):
        ...
        # High quality face should give high confidence
    ...
    def test_confidence_synthesis_low_face_high_gait(self):
        ...
        # Should be medium (not low, thanks to gait boost)
    ...
    def test_confidence_synthesis_conflict(self):
        ...
        # Get confidence WITHOUT conflict (same IDs)
        ...
        # Confidence with conflict should be lower
