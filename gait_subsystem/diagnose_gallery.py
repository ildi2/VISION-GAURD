...
def diagnose():
    ...
    # 1. Check Identities & Anthro Stats
    ...
    # 2. Self-Search Test
    # Take the first template of 'marildo' and search against the whole gallery
