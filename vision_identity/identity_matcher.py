...
Usage:
  python -m vision_identity.identity_matcher sync [--dry-run] [--min-confidence 0.7]
  python -m vision_identity.identity_matcher link <face_id> <gait_id> [display_name]
  python -m vision_identity.identity_matcher show

Examples:
  python -m vision_identity.identity_matcher sync
  python -m vision_identity.identity_matcher sync --dry-run
  python -m vision_identity.identity_matcher link p_0007 marildo "Marildo Cani"
""")
        sys.exit(0)
