...
def main():
    print("="*60)
    print("VISION IDENTITY GALLERY STATUS CHECK")
    print("="*60)
    ...
    if not gait_identities:
        ...
        print("   → Enroll gaits using: python -m motion_analysis.enrollment_cli")
    
    if not registry_persons and matches:
        print("\n💡 Matches found but registry is empty!")
        print("   → Run sync: python -m vision_identity.enrollment_integration sync")
